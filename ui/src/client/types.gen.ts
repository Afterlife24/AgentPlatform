...
export type ClientOptions = {
    baseUrl: 'https://app.afterlife.ai' | 'http://localhost:8000' | (string & {});
};
...
export type DograhEmbeddingsConfiguration = {
     ...
     * Model
     *
     * Afterlife-managed embedding model.
     */
    model?: string;
};
...
export type GoogleTtsConfiguration = {
     ...
     * Model
     *
     * Google Cloud low-latency TTS engine. Afterlife maps this to Pipecat's streaming Google TTS service for Chirp 3 HD and Journey voices.
     */
    model?: string;
    /**
     * Voice
...
export type HttpApiConfig = {
     ...
     * Preset Parameters
     *
     * Parameters injected by Afterlife from fixed values or workflow context templates.
     */
 ...
 * PresetToolParameter
 *
 * A parameter injected by Afterlife at runtime.
 */
...
export type ActiveCallsApiV1HealthActiveCallsGetData = {
    ...
    headers?: {
        /**
         * X-Afterlife-Devops-Secret
         */
        'X-Afterlife-Devops-Secret'?: string | null;
    };
    path?: never;
    query?: never;
