...
export function DograhCreditsCard() {
  ...
  return (
    <Card className="mb-6">
      <CardHeader>
        <CardTitle>Afterlife Model Credits</CardTitle>
        <CardDescription>
          These track usage of Afterlife models using Afterlife Service Keys.
        </CardDescription>
      </CardHeader>
      <CardContent>
        {isLoadingCredits ? (
          ...
          <p className="text-muted-foreground">
            No Afterlife service keys configured. Set up a service key in your model configuration to see usage.
          </p>
        )}
